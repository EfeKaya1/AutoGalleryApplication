...
namespace OtoGaleriUygulamasi
{
    internal class AracGerecler
    {
        ...
        {
            int sayi;
            //Ön koşul: Girilen plaka minimum 7 maksimum 9 haneli, ilk iki hanesi sayılardan oluşmalı,
            //6. ve 7.(5. ve 6. indeks) haneler sayı olmalı ve plakaların 3. haneleri(2. indeks) mutlaka harf olmalıdır.
